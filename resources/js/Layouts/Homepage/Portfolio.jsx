...
export default function Index() {
    return (
        <div className="container mx-auto">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 grid md:grid-cols-2 lg:items-center md:text-left text-center lg:justify-between lg:px-8">
                <div className="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    <span className="block md:text-5xl">Portofolio</span>
                </div>
            </div>
